        ...
        <div className="flex flex-col gap-3">
            ...
            </div>
            {
                ...
                events.map((event: IEvent) => {
                    return (
                        <Link shallow href={`/space/${photoSpace?.spaceId}/events/${event._id}`} onClick={() => { setEvent(event) }} className="w-full flex gap-x-2 border border-transparent hover:border-primary rounded-md p-3 relative bg-accent/20 ease-in-out duration-500 cursor-pointer">
